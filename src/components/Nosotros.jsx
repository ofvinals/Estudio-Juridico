	...
	return (
		<div className='about'>
			...
			<p className='parrafoabout lh-lg'>
				...
				sólida, nos hemos dedicado a brindar servicios legales de calidad y
				a establecer relaciones duraderas con nuestros clientes.- <br />{' '}
				Nuestro compromiso es brindar un servicio legal confiable, ético y
				orientado a obtener resultados positivos. Basados en la excelencia,
				la integridad y la atención personalizada. Trabajamos en estrecha
				colaboración con nuestros clientes, comprendiendo sus necesidades y
				objetivos legales, para ofrecerles un asesoramiento integral y
				adaptado a cada situación.
			</p>

			<div className='d-flex row row-cols-12 justify-content-center p-3'>
				<Card.Body className='cardabout'>
					<Card.Title className='cardtitle'>Mision</Card.Title>
				...
				<Card.Body className='cardabout'>
					<Card.Title className='cardtitle'>Vision</Card.Title>
				...
				<Card.Body className='cardabout'>
					<Card.Title className='cardtitle'>Valores</Card.Title>
			...
			<div className='d-flex'>
				<h1 className='tituloabout text-center mt-0'>NUESTRO TEAM</h1>
			</div>
		</div>
	);
};
